package com.example.khudyakovlab.network.api.deserializers
...
class FilmDetailDeserializer : JsonDeserializer<FilmResponse> {
    override fun deserialize(
        ...
        val countriesJson: JsonArray = json?.asJsonObject?.get("countries")?.asJsonArray?: JsonArray()
        ...
        val film: FilmResponse = FilmResponse(
            id,
